...
namespace WPR
{
    internal class AppResolver : AssemblyLoadContext, IDisposable
    {
        ...
        Assembly LoadXnaAssembly(AssemblyLoadContext context, AssemblyName requiredName)
        {
            ...
            return AssemblyUtils.SaveExistingAssemblyAsAndReload(context, 
                "MonoGame.Framework", def);
        }

        Assembly ResolveMissingDependencies
        (
        ...
        )
        {
            ...
            if 
            (
                (assemblyNameInString.Equals("Microsoft.Xna.Framework", 
